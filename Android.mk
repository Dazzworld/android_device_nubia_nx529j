...
ALIPAY_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR)/firmware/,$(notdir $(ALIPAY_IMAGES)))
$(ALIPAY_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "ALIPAY firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(ALIPAY_SYMLINKS)
...
CPE_IMAGES := \
    cpe.b02 cpe.b04 cpe.b06 cpe.b08 cpe.b10 cpe.b11 cpe.b12 cpe.b14 \
